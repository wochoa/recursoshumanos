...
import logoDarkLg from '../../images/logo-dark2.png';
import logoDarkSm from '../../images/logo2.svg';
import logoLightLg from '../../images/logo-light2.png';
import logoLightSm from '../../images/logo-light2.svg';
...
export default {
    ...
    mounted() {
        ...
        this.activodark = this.$root.layout.mode == 'dark' ? true : false;

        this.$store.dispatch('usuarios/Totalusuarios');
    },
    computed: {
        datosdeluser() {
    ...
    methods: {
        changeLayoutMode(mode) {
            if (mode == 'dark') {
                this.activodark = true
            } else {
                this.activodark = false
            }
...
<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <router-link to="/" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img :src="logoDarkLg" alt height="36" />
                    </span>
                </router-link>
                ...
                <router-link to="/" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img :src="logoLightLg" alt height="36" />
                    </span>
                </router-link>
            </div>
        ...
        <div class="d-flex">
            ...
            <b-dropdown variant="white" right toggle-class="header-item">
                ...
                <b-dropdown-item class="notify-item" v-for="(entry, i) in languages" :key="`Lang${i}`" :value="entry" @click="setLanguage(entry.language, entry.title, entry.flag)" :class=" {'active' : lan === entry.language}">
            ...
            <div class="dropdown d-none d-lg-inline-block ms-1" v-if="activodark">
                <button type="button" class="btn header-item noti-icon" @click="changeLayoutMode('default')">
                    <i class="bx bx-sun"></i>
                </button>
            </div>
            <div class="dropdown d-none d-lg-inline-block ms-1" v-else>
                <button type="button" class="btn header-item noti-icon" @click="changeLayoutMode('dark')">
            ...
            <b-dropdown right variant="black" toggle-class="header-item" menu-class="dropdown-menu-end">
                <template v-slot:button-content>
                    ...
                    <span class="d-none d-xl-inline-block ms-1">{{ datosdeluser.adm_email}}</span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </template>
                <!-- item-->

                <router-link to="/usuario/perfil" class="dropdown-item">
            ...
            {{ $t('navbar.dropdown.henry.list.mywallet') }}
                ...
                <b-dropdown-item class="d-block" href="javascript: void(0);" @click="isOpencambiopas = true">
    ...
    <!-- <b-button @click="isOpencambiopas = true" variant="primary">Center modal</b-button> -->
    <b-modal v-model="isOpencambiopas" id="modal-center" centered title="Cambiar contraseña" title-class="font-18" @ok="handleOk">
        <p>
            estimado(a), {{ datosdeluser.fullname }}, estas a punto de modificar su contraseña.
        </p>
        <div class="form-group row">
            ...
            <div class="col-7">
                <input type="text" class="form-control form-control-sm" placeholder="Contraseña anterior">
            </div>
        </div>
